        ...
        <div className='mb-12'>
            <AwesomeSlider className='mb-12'>
                <div className="slider-item">
                    ...
                    <h2 className="legend-left text-black text-2xl md:text-4xl">Discover the <br /> Joy of Music</h2>
                </div>
                <div className="slider-item">
                    ...
                    <h2 className="legend-left text-green-400 text-2xl md:text-4xl">Experience the <br /> Power of  Harmony</h2>
                </div>
                <div className="slider-item">
                    ...
                    <h2 className="legend-left text-pink-700 text-2xl md:text-4xl">Embrace the <br /> Rhythm of Life</h2>
                </div>
                <div className="slider-item">
                    ...
                    <h2 className="legend-left text-cyan-600 text-2xl md:text-4xl">Elevate Your <br /> Musical Journey</h2>
                </div>
            </AwesomeSlider>
        </div>
